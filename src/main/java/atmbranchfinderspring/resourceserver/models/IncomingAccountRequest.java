...
public class IncomingAccountRequest {
    private String id;
    private List<String> permissions;
    private LocalDateTime transactionFromDateTime;
    private LocalDateTime transactionToDateTime;

	public IncomingAccountRequest() {

    }

    public IncomingAccountRequest(String id, List<String> permissions, LocalDateTime transactionFromDateTime, LocalDateTime transactionToDateTime) {
        this.id = id;
